...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aiteast
```

A live public deployment of this template is available at [https://aiteast.templates.workers.dev](https://aiteast.templates.workers.dev)
